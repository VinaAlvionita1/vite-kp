              ...
              <form>
                <div class="pl-lg-3">
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                        <label class="form-control-label" for="nama">Nama Tugas</label>
                        <input type="text" id="nama"  class="form-control" placeholder="Masukkan Nama Tugas">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <textarea id="nama_proyek"  class="form-control" placeholder="Masukkan Keterangan"/>
                      </div>
                    </div>
                    <div class="col-lg-2">
                      <div class="form-group">
                        <label class="form-control-label" for="tgl_mulai_proyek">Tanggal Mulai</label>
                        <input type="date" id="thn_anggaran"  class="form-control" placeholder="Tanggal Mulai">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-2">
                      <div class="form-group">
                        ...
                        <input type="date" id="dinas"  class="form-control" placeholder="Tanggal Selesai">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <select class="form-control" id="status">
                          <option disabled value="" selected="selected">Pilih Status</option>
